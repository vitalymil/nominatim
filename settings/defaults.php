...
@define('CONST_Database_DSN', 'pgsql://postgres:postgres@osm-dev-db/nominatim'); // <driver>://<username>:<password>@<host>:<port>/<database>
@define('CONST_Database_Web_User', 'postgres');
...
@define('CONST_Pyosmium_Binary', '/root/.local/bin/pyosmium-get-changes');
...
@define('CONST_Replication_Url', 'file:///rep_data/minutely-export');
